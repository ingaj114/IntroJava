...
//
//         Features of Java
//         Java is a strictly-typed, compiled language, it is turned into 'bytecode'
...
//         - long
//         - float - which stores bigger whole numbers and decimal numbers - has a max of 7 decimal places
//         - double // has a max of 15 decimal places.
//
//         - char - which stores single characters using single quotes.
//
//         - Complex Objects
//         - Strings - which stores multiple characters using double quotes
//
...
//      Shortcut to comment a line of code: CTRL + /
...
//        System.out.println(
//                "The person x is " + gender + " and person is " + age + " years old. " +
//                        "Her weight is " + weight + " and her height is " + height + " m.");
//         Type conversion
...
//
// TASK:   Evaluate the following expressions using relational and logical operators:
