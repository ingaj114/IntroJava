...
//        System.out.println(matcher2.matches()); // This returns true if they match and false if not.
        ...
        // Tasks:
        // Task 1: 15 mins
        // Write a program that accepts a string from the user and returns the number of vowels that can be found in that string.
        // For example: If the user enters the string, "Bodacious" -> 5 Caveat: Make your program interactive.

        // Task 2: 15 mins
        // Write a program that accepts 5 numbers from a user AS STRINGS. DO NOT USE THE nextInt() method.
        // Add the first two numbers and subtract the second two numbers and multiply the result of the calculation above, then
