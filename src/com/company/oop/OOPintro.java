...
public class OOPintro {
    ...
    /*System.out.println(Calculator.add(2,4));
      ...
      /*Person george = new Person("George", 28);
        ...
        Person person1 = new Person(59, 1.69);

        System.out.print("If a weight of a person is " + person1.getWeight() + " kg "
                + "and height is " + person1.getHeight() + " cm, then BMI is " + Math.round(person1.Result()));
